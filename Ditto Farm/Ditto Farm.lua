...
function GoToDitto1() --all methods currently use the same path, you can change these and set it up if you like
	Trainer.Bike.MoveLeft(8)
	CheckPosition(7, 8)
	Trainer.Bike.MoveDown(2)
	CheckPosition(7, 9)
	Trainer.Bike.MoveLeft(19)
	CheckPosition(29, 9)
	Trainer.Bike.MoveUp(5)
	sleep(3000 + SlowModeDelay)
	CheckPosition(4, 7)
	Trainer.Bike.MoveUp(6)
	sleep(3000 + SlowModeDelay)
	CheckPosition(6, 25)
	Trainer.Bike.MoveUp(19)
	CheckPosition(6, 6)
	Trainer.Bike.MoveLeft(2)
	CheckPosition(5, 6)
	Trainer.Bike.MoveUp(3)
	CheckPosition(5, 4)
	Trainer.Bike.MoveRight(2)
	CheckPosition(6, 4)
	Trainer.Bike.MoveUp(3)
	sleep(3000 + SlowModeDelay)
	CheckPosition(10, 12)
	Trainer.Bike.MoveUp(2)
end
function GoToDitto2()
	Trainer.Bike.MoveLeft(8)
	CheckPosition(7, 8)
...
function SearchBattle()
	...
	while(true) do
		...
		if(Trainer.GetX() <= 38 and RightGoing) then
			Trainer.Bike.MoveRight(1)
		else
			RightGoing = false
			Trainer.Bike.MoveLeft(1)
